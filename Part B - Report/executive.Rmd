...
The purpose of this study is to identify the variables contributing to the fatal accidents in Victoria, Australia by collecting information on road accidents from 2006 to 2020. In this regard, the logistic regression model is used to recognize the most influential variables on the fatal accidents given an accident has occurred. 
